...
2. Screenshot with simulated time waveforms. Always display all inputs and outputs (display the inputs at the top of the image, the outputs below them) at the appropriate time scale!
   ...
   ![image](https://user-images.githubusercontent.com/99763701/157066632-18822ac1-e9f0-4aca-95e8-08287cf61272.png)
...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { c_i[0] }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { c_i[1] }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
